  ...
  return (
    <>
      ...
      <div className='flex flex-wrap mb-16 gap-5 justify-center '>
       <div className=' bg-[#f4b7ff] shadow-[0px_0px_4px_black] p-3 rounded-md'>
        <Upload01Icon size={40}  className='p-2 rounded-md bg-gradient-to-r  to-[#9C27B0] from-blue-500   '/>
        <p className='font-bold'>upload image</p>
        <p>This is demo text will be replaced it later</p>
       </div>
       <div className=' bg-[#94afff] shadow-[0px_0px_4px_black] p-3 rounded-md'>
       ...
       <div className=' bg-[#d1aeff] shadow-[0px_0px_4px_black] p-3 rounded-md'>
